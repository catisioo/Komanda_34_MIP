...
# num1button = tk.Button(leftFrame, text="23040", font=('Cascadia Mono ExtraLight', 16))
# num1button.pack(padx=20, pady=10)

# num2button = tk.Button(leftFrame, text="29360", font=('Cascadia Mono ExtraLight', 16))
# num2button.pack(padx=20, pady=10)

# num3button = tk.Button(leftFrame, text="20102", font=('Cascadia Mono ExtraLight', 16))
# num3button.pack(padx=20, pady=10)

# num4button = tk.Button(leftFrame, text="22222", font=('Cascadia Mono ExtraLight', 16))
# num4button.pack(padx=20, pady=10)

# num5button = tk.Button(leftFrame, text="21000", font=('Cascadia Mono ExtraLight', 16))
...
# newGamebutton = tk.Button(newGameFrame, text="New Game", font=('Cascadia Mono ExtraLight', 10))
